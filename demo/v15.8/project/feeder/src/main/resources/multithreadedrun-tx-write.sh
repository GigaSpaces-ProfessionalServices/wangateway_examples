...
export GS_LOOKUP_LOCATORS="172.31.13.223:4174"
export GS_LOOKUP_GROUPS="xap-15.8.1"

$JAVA_HOME/bin/java -Xms1g -Xmx1g -classpath "$CLASSPATH" com.gigaspaces.demo.feeder.MultithreadedFeeder -spaceName Product -numThreads 2 -rateInterval 5 \
  -writeCount 5000 \
  -maxObjects 300000 \
  -payloadSize 1000 \
  -leaseTimeout 900000 \
  ...
  -site 3 \
  -username giga_user \
  -password giga_user | tee /tmp/$0.out
