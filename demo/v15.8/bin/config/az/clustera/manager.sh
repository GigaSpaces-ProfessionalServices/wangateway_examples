...
export GS_MANAGER_SERVERS="172.31.14.28;lus=$UNICAST_PORT,172.31.1.240;lus=$UNICAST_PORT,172.31.1.186;lus=$UNICAST_PORT"

export REST_HOST="172.31.14.28:8090"

# for admin WAN GW bootstrap and modifyTarget
export BOOTSTRAP_LOCATOR="172.31.14.28:$UNICAST_PORT"
